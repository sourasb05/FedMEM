...
def args_parser():
    ...
    parser.add_argument("--dataset", type=str, default=DefaultDataset, choices=["fmnist","femnist","human_activity", "gleam","vehicle_sensor","mnist", "Synthetic", "Cifar10", "Emnist", "Cifar100"])
    ...
    parser.add_argument("--total_users", type=int, default=50, help="total users")
