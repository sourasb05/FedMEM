...
def read_data(args):
    ...
    train_data_dir = os.path.join(current_directory,'FedMEM', 'dataset','train')
    test_data_dir = os.path.join(current_directory, 'FedMEM', 'dataset', 'test')
    ...
    # train_file = current_directory + "/FedMEM/dataset/train/fedr3_train.json"
    train_file = "/proj/sourasb-220503/Predicting-Event-Memorability/FedMEM/dataset/train/fedr3_train.json"
    print(train_file)
    ...
    test_file = "/proj/sourasb-220503/Predicting-Event-Memorability/FedMEM/dataset/test/fedr3_test.json"
    print(test_file)
