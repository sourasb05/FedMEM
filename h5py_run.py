...
import numpy as np
attributes = []
# path = '/proj/sourasb-220503/FedMEM/results/fixed_client_56/target_10/'
path = '/proj/sourasb-220503/FedMEM/results/fixed_client_16/target_3/'
hf = h5py.File(path + '_exp_no_0_GR_50_BS_64_data_silo_100_num_user_24.0'+'.h5','r')
id = 0
